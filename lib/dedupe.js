...
import { parsePlaylist, sampleForBitrate } from './m3u8.js';
...
// Media:   { role: 'media', duration, live, sample }
//          sample is the leading segments to probe for a bitrate estimate
//          (see sampleForBitrate); empty when the playlist has no segments.
